            ...
            if (invoker instanceof ResourceMethodInvoker) {
               ...
               for (Class<?> locatorResourceType : locatorResourceTypes) {
                  if (locatorResourceType == null) {
                     ...
                     // just logging this
                     log.warn("Impossible to generate WADL for subresource returned by method " + method.getDeclaringClass().getName() + "." + method.getName() + " since return type is not a static JAXRS resource type");
                     continue;
                  }
